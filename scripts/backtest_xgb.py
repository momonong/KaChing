...
if __name__ == '__main__':
    ...
    # 載入模型
    print("[INFO] Loading pre-trained XGBoost model...")
    model = joblib.load('model/xgb_model_final.joblib')
    ...
    # 執行回測 (與 evaluate_xgb.py 腳本中的回測邏輯完全相同)
    print("[INFO] Starting backtest simulation...")
    # ... (此處省略，請將 evaluate_xgb.py 中完整的、精確的回測與基準測試程式碼複製到這裡) ...
